...
export const DESTINATIONS: Destination[] = [
  ...
  /*
   * **Obsidian came off on 2026-08-16 with the Markdown export.** The rule for
   * this list is that a destination needs an export that actually opens in it,
   * and Markdown is held back until it ships as a folder rather than a file —
   * see `FORMATS` in `export-page.tsx`. Its entry goes back in the same commit
   * that switches the format on; nothing else here changes, because the mosaic
   * and the export dialog both count this list rather than a number.
   */
];
