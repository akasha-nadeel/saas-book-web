        ...
        <div className="mt-8 flex flex-col gap-6">
          <section>
            ...
            <p className="mt-1 font-sans text-sm leading-relaxed text-muted">
              The panel holds a card for each part of a book, in the order they
              are bound: <span className="text-fg">Front matter</span>,{" "}
          ...
          <section>
            ...
            <p className="mt-3 font-sans text-sm leading-relaxed text-muted">
              Press <span className="text-fg">Start</span> on either and it makes
              a page already laid out with that part’s standard sections as
              headings, for you to fill in:
            </p>
